...
class LlmResponseParser:
    ...
    def AnswerCAG(
        ...
        __result__ = self.__options.merge_options(baml_options).parse_response(function_name="AnswerCAG", llm_response=llm_response, mode="request")
...
class LlmStreamParser:
    ...
    def AnswerCAG(
        ...
        __result__ = self.__options.merge_options(baml_options).parse_response(function_name="AnswerCAG", llm_response=llm_response, mode="stream")
        return typing.cast(str, __result__)
